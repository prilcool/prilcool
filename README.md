...
---
- 🛠️ **Current Focus:** 2D Game Development, Cybersecurity, and Quantum Computing logic.
- ⚖️ **Philosophy:** I build with a "Bare Metal" mindset—prioritizing runtime efficiency and simple, direct code (KISS).
